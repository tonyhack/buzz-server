...
class EventTaskFinish:
  ...
  thrift_spec = (
    ...
    (2, TType.I32, 'task_id_', None, None, ), # 2
    (3, TType.I32, 'type_', None, None, ), # 3
  )

  def __init__(self, actor_id_=None, task_id_=None, type_=None,):
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      ...
      return
    oprot.writeStructBegin('EventTaskFinish')
    ...
    if self.task_id_ is not None:
      oprot.writeFieldBegin('task_id_', TType.I32, 2)
...
class EventTaskAccept:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('EventTaskAccept')
    if self.actor_id_ is not None:
      oprot.writeFieldBegin('actor_id_', TType.I64, 1)
      oprot.writeI64(self.actor_id_)
      oprot.writeFieldEnd()
