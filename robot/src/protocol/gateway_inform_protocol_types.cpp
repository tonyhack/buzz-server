...
const char* MessageInformNotify::ascii_fingerprint = "B8D94EBFFE99C6E7010418EB2DF36DC3";
const uint8_t MessageInformNotify::binary_fingerprint[16] = {0xB8,0xD9,0x4E,0xBF,0xFE,0x99,0xC6,0xE7,0x01,0x04,0x18,0xEB,0x2D,0xF3,0x6D,0xC3};

uint32_t MessageInformNotify::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t MessageInformNotify::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("MessageInformNotify");
