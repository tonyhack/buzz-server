...
#ifndef __GAME__SERVER__ITEM__FIGHTING__STATUS__EVENT__HANDLER__H
#define __GAME__SERVER__ITEM__FIGHTING__STATUS__EVENT__HANDLER__H
...
#endif  // __GAME__SERVER__ITEM__FIGHTING__STATUS__EVENT__HANDLER__H
