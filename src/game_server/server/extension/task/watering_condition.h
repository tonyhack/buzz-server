...
#ifndef __GAME__SERVER__TASK__WATERING__CONDITION__H
#define __GAME__SERVER__TASK__WATERING__CONDITION__H
...
class WateringCondition : public Condition {
 public:
  WateringCondition();
  virtual ~WateringCondition();
  ...
  virtual entity::TaskCondition::type GetType() const {
    return entity::TaskCondition::WATERING;
  }
...
#endif  // __GAME__SERVER__TASK__WATERING__CONDITION__H
