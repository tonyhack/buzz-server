#ifndef __GAME__SERVER__GUILD__SCENE__ROLE__CREATE__EVENT__HANDLER__H
#define __GAME__SERVER__GUILD__SCENE__ROLE__CREATE__EVENT__HANDLER__H
...
#endif  // __GAME__SERVER__GUILD__SCENE__ROLE__CREATE__EVENT__HANDLER__H
