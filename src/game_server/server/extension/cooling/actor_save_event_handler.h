...
#ifndef __GAME__SERVER__COOLING__ACTOR__SAVE__EVENT__HANDLER__H
#define __GAME__SERVER__COOLING__ACTOR__SAVE__EVENT__HANDLER__H
...
#endif  // __GAME__SERVER__COOLING__ACTOR__SAVE__EVENT__HANDLER__H
