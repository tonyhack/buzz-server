...
#ifndef __GAME__SERVER__EFFECT__ACTOR__LOGOUT__EVENT__HANDLER__H
#define __GAME__SERVER__EFFECT__ACTOR__LOGOUT__EVENT__HANDLER__H
...
#endif  // __GAME__SERVER__EFFECT__ACTOR__LOGOUT__EVENT__HANDLER__H
