...
OwnershipCampEach::OwnershipCampEach() {}
OwnershipCampEach::~OwnershipCampEach() {}

bool OwnershipCampEach::Initialize(SceneNpc *npc) {
...
void OwnershipCampEach::Finalize() {
  Ownership::Finalize();
}

void OwnershipCampEach::OnEvent(event::EventType::type type,
...
void OwnershipCampEach::OnEventRoleKilled(const void *message, size_t size) {
