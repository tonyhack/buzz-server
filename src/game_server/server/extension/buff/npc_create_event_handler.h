...
#ifndef __GAME__SERVER__BUFF__NPC__CREATE__EVENT__HANDLER__H
#define __GAME__SERVER__BUFF__NPC__CREATE__EVENT__HANDLER__H
...
#endif  // __GAME__SERVER__BUFF__NPC__CREATE__EVENT__HANDLER__H
