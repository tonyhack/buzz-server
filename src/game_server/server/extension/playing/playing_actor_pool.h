...
#ifndef __GAME__SERVER__PLAYING__PLAYING__ACTOR__POOL__H
#define __GAME__SERVER__PLAYING__PLAYING__ACTOR__POOL__H
...
#endif  // __GAME__SERVER__PLAYING__PLAYING__ACTOR__POOL__H
