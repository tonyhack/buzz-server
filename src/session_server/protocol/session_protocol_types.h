 ...
 *  @generated
 */
#ifndef session_protocol_TYPES_H
#define session_protocol_TYPES_H
...
struct MessageType {
  enum type {
    ...
    MESSAGE_GAME_SERVER = 7,
    MESSAGE_GATEWAY_SERVER = 8,
    MESSAGE_MAX = 9
  };
};
...
class MessageGameServer {
 public:

  static const char* ascii_fingerprint; // = "3F5FC93B338687BC7235B1AB103F47B3";
  static const uint8_t binary_fingerprint[16]; // = {0x3F,0x5F,0xC9,0x3B,0x33,0x86,0x87,0xBC,0x72,0x35,0xB1,0xAB,0x10,0x3F,0x47,0xB3};

  MessageGameServer() : type_(0), message_() {
  }

  virtual ~MessageGameServer() throw() {}
  ...
  bool operator == (const MessageGameServer & rhs) const
  {
    if (!(type_ == rhs.type_))
      return false;
    if (!(message_ == rhs.message_))
  ...
  bool operator < (const MessageGameServer & ) const;
...
class MessageGatewayServer {
 public:

  static const char* ascii_fingerprint; // = "3F5FC93B338687BC7235B1AB103F47B3";
  static const uint8_t binary_fingerprint[16]; // = {0x3F,0x5F,0xC9,0x3B,0x33,0x86,0x87,0xBC,0x72,0x35,0xB1,0xAB,0x10,0x3F,0x47,0xB3};

  MessageGatewayServer() : type_(0), message_() {
  }

  virtual ~MessageGatewayServer() throw() {}
  ...
  bool operator == (const MessageGatewayServer & rhs) const
  {
    if (!(type_ == rhs.type_))
      return false;
    if (!(message_ == rhs.message_))
  ...
  bool operator < (const MessageGatewayServer & ) const;
