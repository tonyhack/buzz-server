...
const char* RequestSendMail::ascii_fingerprint = "BDD6359A93867DA942883CC19D6336D9";
const uint8_t RequestSendMail::binary_fingerprint[16] = {0xBD,0xD6,0x35,0x9A,0x93,0x86,0x7D,0xA9,0x42,0x88,0x3C,0xC1,0x9D,0x63,0x36,0xD9};

uint32_t RequestSendMail::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t RequestSendMail::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  xfer += oprot->writeStructBegin("RequestSendMail");
