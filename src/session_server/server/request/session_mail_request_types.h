 ...
 *  @generated
 */
#ifndef session_mail_request_TYPES_H
#define session_mail_request_TYPES_H
...
typedef struct _RequestSendMail__isset {
  _RequestSendMail__isset() : type_(false), affix_(false), context_(false) {}
  bool type_;
  bool affix_;
  bool context_;
} _RequestSendMail__isset;
...
class RequestSendMail {
 public:
  ...
  RequestSendMail() : id_(0), type_(( ::entity::MailType::type)0), child_type_(( ::entity::SystemMailChildType::type)0), context_() {
  }

  virtual ~RequestSendMail() throw() {}
  ...
  _RequestSendMail__isset __isset;
  ...
  bool operator == (const RequestSendMail & rhs) const
  {
    if (!(id_ == rhs.id_))
      return false;
  ...
  bool operator < (const RequestSendMail & ) const;
...
void swap(RequestSendMail &a, RequestSendMail &b);
