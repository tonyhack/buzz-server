...
#ifndef __DATABASE__SERVER__STORAGE__COOLING__LOGIN__H
#define __DATABASE__SERVER__STORAGE__COOLING__LOGIN__H
...
class StorageCoolingLogin : public core::Noncopyable {
 public:
  StorageCoolingLogin();
  ~StorageCoolingLogin();
 ...
 private:
  ...
  void OnResponse(const protocol::StorageCoolingLoginResponse &response,
...
#endif  // __DATABASE__SERVER__STORAGE__COOLING__LOGIN__H
