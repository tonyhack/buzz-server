...
#ifndef __DATABASE__SERVER__STORAGE__COOLING__SAVE__H
#define __DATABASE__SERVER__STORAGE__COOLING__SAVE__H
...
class StorageCoolingSave : public core::Noncopyable {
 public:
  StorageCoolingSave();
  ~StorageCoolingSave();
 ...
 private:
  ...
  void OnResponse(const protocol::StorageCoolingSaveResponse &response,
...
#endif  // __DATABASE__SERVER__STORAGE__COOLING__SAVE__H
