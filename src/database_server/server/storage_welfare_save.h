#ifndef __DATABASE__SERVER__STORAGE__WELFARE__SAVE__H
#define __DATABASE__SERVER__STORAGE__WELFARE__SAVE__H
...
class StorageWelfareSave : public core::Noncopyable {
 public:
  StorageWelfareSave();
  ~StorageWelfareSave();
 ...
 private:
  ...
  void OnResponse(const protocol::StorageWelfareSave &response,
...
#endif  // __DATABASE__SERVER__STORAGE__WELFARE__SAVE__H
