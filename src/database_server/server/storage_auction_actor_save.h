#ifndef __DATABASE__SERVER__STORAGE__AUCTION__ACTOR__SAVE__H
#define __DATABASE__SERVER__STORAGE__AUCTION__ACTOR__SAVE__H
...
class StorageAuctionActorSave : public core::Noncopyable {
 public:
  StorageAuctionActorSave();
  ~StorageAuctionActorSave();
 ...
 private:
  ...
  void OnResponse(const protocol::StorageAuctionActorSaveResponse &response,
...
#endif  // __DATABASE__SERVER__STORAGE__AUCTION__ACTOR__SAVE__H
