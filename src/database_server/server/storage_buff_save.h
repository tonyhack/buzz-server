...
// File name: storage_buff_save.h
//
// Description:
// Define class StorageBuffSave.
//

#ifndef __DATABASE__SERVER__STORAGE__BUFF__SAVE__H
#define __DATABASE__SERVER__STORAGE__BUFF__SAVE__H
...
class StorageBuffSave : public core::Noncopyable {
 public:
  StorageBuffSave();
  ~StorageBuffSave();
 ...
 private:
  ...
  void OnResponse(const protocol::StorageBuffSaveResponse &response,
...
#endif  // __DATABASE__SERVER__STORAGE__BUFF__SAVE__H
