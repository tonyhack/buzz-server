#ifndef __DATABASE__SERVER__STORAGE__GUILD__SAVE__H
#define __DATABASE__SERVER__STORAGE__GUILD__SAVE__H
...
class StorageGuildSave : public core::Noncopyable {
 public:
  StorageGuildSave();
  ~StorageGuildSave();
 ...
 private:
  ...
  void OnResponse(const protocol::StorageGuildSaveResponse &response,
...
#endif  // __DATABASE__SERVER__STORAGE__GUILD__SAVE__H
