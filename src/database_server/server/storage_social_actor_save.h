#ifndef __DATABASE__SERVER__STORAGE__SOCIAL__ACTOR__SAVE__H
#define __DATABASE__SERVER__STORAGE__SOCIAL__ACTOR__SAVE__H
...
class StorageSocialActorSave : public core::Noncopyable {
 public:
  StorageSocialActorSave();
  ~StorageSocialActorSave();
 ...
 private:
  ...
  void OnResponse(const protocol::StorageSocialActorSaveResponse &response,
...
#endif  // __DATABASE__SERVER__STORAGE__SOCIAL__ACTOR__SAVE__H
