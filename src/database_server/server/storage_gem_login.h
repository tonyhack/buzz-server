#ifndef __DATABASE__SERVER__STORAGE__GEM__LOGIN__H
#define __DATABASE__SERVER__STORAGE__GEM__LOGIN__H
...
class StorageGemLogin : public core::Noncopyable {
 public:
  StorageGemLogin();
  ~StorageGemLogin();
 ...
 private:
  ...
  void OnResponse(const protocol::StorageGemLoginResponse &response,
...
#endif  // __DATABASE__SERVER__STORAGE__GEM__LOGIN__H
