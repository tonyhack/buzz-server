...
// Last modify: 2013-01-22 10:20:30.
// File name: main.cc
//
// Description:
// Define main.
...
int main(int argc, char *argv[]) {
  ...
  // Server initialize.
  database::test::ApplicationServer server(core::InetAddress(server_info->ip_, server_info->port_),
      "TestServer");
  if(server.Initialize(server_info->log_ + server_log_name + "-" + iterator->second, signature) == false) {
